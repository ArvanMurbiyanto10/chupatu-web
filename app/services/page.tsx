...
export default function ServicesPage() {
  ...
  // --- FIX VERCEL TYPESCRIPT VARIANTS ---
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.container}>
        ...
        <div className="flex flex-col lg:flex-row gap-6 w-full h-[70vh] min-h-[550px] max-h-[800px] relative z-10 mb-20">
          {/* BAGIAN KIRI: KARTU / GAMBAR BESAR */}
          <motion.div
            layout
              ...
              servicesData.map((srv, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`relative rounded-[2rem] overflow-hidden cursor-pointer group flex ${
                      isActive ? "flex-[5] lg:flex-[6]" : "flex-[1]"
                    }`}
                  >
                    <motion.img
                    ...
                    <div
                      className={`absolute inset-0 transition-opacity duration-500 ${
                        isActive
                          ? "bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent opacity-90"
                    ...
                    <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end w-full h-full">
                      {isActive ? (
                        ...
                        >
                          ...
                          <button
                            onClick={(e) => {
                              // e.stopPropagation() mencegah trigger klik dari div parent
                              e.stopPropagation();
                              setShowDetail(true);
                            }}
          ...
          {/* BAGIAN KANAN: PANEL DETAIL PENJELASAN (Dikembalikan!) */}
          <AnimatePresence>
            {showDetail && (
              <motion.div
